...
const AboutUsTop = () => {
  return (
    ...
    <div className="container mx-auto flex flex-col items-center justify-center  py-15">
      {/* Top Section */}
      <div className="relative z-0 w-full max-w-7xl h-100 bg-gradient-to-r from-[#FEC5C5] to-[#FFFCA7] text-black rounded-xl flex flex-col pt-20 items-center justify-start shadow-lg">
      ...
      {/* Bottom Section */}
      <div className="relative z-10 -mt-40 w-full max-w-4xl  text-black rounded-xl">
